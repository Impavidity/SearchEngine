...
def preprocess(database):
    ...
    return Voc(entries), entries, id_html
...
def parse(database = config.DATABASE_PATH):
    print 'Parsing vocabulary and entry .............'
    voc, entries, id_html = preprocess(database)
    print 'Parsed vocabulary and entry.'

    print 'Constructing tiered index ..............'
    return construct_tiered_index(voc, entries), id_html
